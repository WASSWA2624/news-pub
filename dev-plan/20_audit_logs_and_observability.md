...
2. Build job and log views for stream runs, publish attempts, failure summaries, shared-fetch execution mode or window details, AI skip or fallback visibility, and flattened Meta pacing or guardrail diagnostics.
...
- jobs and post history surfaces show one operator-facing reason code and message for pacing or policy guardrail blocks
