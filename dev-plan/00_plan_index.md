...
- the operator-visible default manual fetch window of the previous 24 hours through the next 30 minutes from now, provider capability mapping guidance, or Meta pacing diagnostics required by the current write-up
