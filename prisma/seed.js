...
const DEFAULT_PROVIDERS = Object.freeze([
  {
    ...
    description: "Mediastack provider integration with broad incremental fetch support.",
    isDefault: true,
    isEnabled: true,
    isSelectable: true,
    label: "Mediastack",
  ...
  },
  {
    ...
    description: "NewsData provider integration with locale-aware article discovery.",
    isDefault: false,
    isEnabled: true,
    isSelectable: true,
    label: "NewsData",
  ...
  },
  {
    ...
    description: "NewsAPI provider integration for broad topic and source searches.",
    isDefault: false,
    isEnabled: true,
    isSelectable: true,
    label: "NewsAPI",
